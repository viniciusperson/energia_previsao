...
with st.sidebar:
    ...
    rf_n_estimators = st.number_input("RF n_estimators", value=500, min_value=50, max_value=2000)
    trend_weight = st.slider("Peso da tendência no RF (0..1)", min_value=0.0, max_value=0.7, value=0.25, step=0.05)
